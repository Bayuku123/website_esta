	...
	<!-- Nav bar -->
		...
		<div class="cover-container pt-5 mt-5">
			<div class="cover-inner container justify-content-center">
				<h1 class="heading mb-3 py-4">Don't be fooled by the banner!</h1>
				<p class="sub-heading pt-5">let's scroll down</p>
			  </div>   
		</div>
	</section>
	<!-- End -->
			...
			$count=0;
				...
				foreach($foodList as $food){
					...
					if ($food[3] == "Maincourse"){
						...
						echo '<span class="pricing">'.'Rp'.number_format((float)$food[2],0,'','').'</span>'; 
