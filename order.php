					...
					<div class="row mt-0 mx-0 mx-lg-5">
								...
								<table class="table table-hover">
									...
									?>	
										<tr>
											...
											<td class="align-middle"><strong>Rp<?php echo  number_format($food_price,0); ?></strong></td>
						...
						<div class="p-4">
							<ul class="list-unstyled mb-4">
								...
								</strong><strong>-Rp<?php echo $_SESSION["discount"]; ?></strong></li>
								
								<li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
									<h5 class="font-weight-bold">Rp<?php echo $grandtotal; ?></h5>
								</li>
							</ul>
