...
<nav class="navbar navbar-toggleable-sm navbar-expand-lg navbar-inverse navbar-fixed-top">
    <div class="container-fluid py-0 justify-content-between">
        <a class="navbar-brand" href="home.php">
            <img class="img-fluid pr-3 pb-1 d-none d-lg-inline" src="images/home/logo2.png" alt="sushi-sama-logo" /><span class="px-2">Restaurant The V-Continental </span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item <?php echo $career ?> px-2 mt-1">
                    <a class="nav-link" href="career.php">Visi & Misi</a>
                </li>
                <?php
