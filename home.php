...
<head>
	...
	<title>Restaurant The V-Continental</title>
	<!-- Bootstrap CSS -->
...
<body>
	...
	<div class="cover text-center" id="home-banner">
		...
		<div class="cover-container py-6">
			<div class="cover-inner container justify-content-center">
				<h1 class="heading mb-3 py-5"> <br /></h1>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-xs-12">
					...
					<div class="info justify-content-center py-2">
						<p>Restaurant V-Continental merupakan restoran yang bergerak di bidiang kuliner western dan nusantara food.
							Berdiri pada tanggal 2 maret 2023, memiliki jumlah karyawan sebanyak 46 orang.
							V-Continental berawal dari V-Coffe biasa yang terletak di komplek citraland gama city blok R3
							no 76-78 yang berdiri pada tanggal 5 februari 2019.
							Namun seiring perkembangannya akhirnya V-Continental kini berada di mall Delipark Lt.3
							di tengah tengah pusat kota medan.
						</p>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid image-banner">
		<div class="cover-inner container justify-content-center">
			<h3 class="image-heading mt-3 pt-5"> Always Fresh and quality dishes</h3>
				<p class="image-text"> for your best taste!</p>
		</div>
	</div>
	<!-- End of Image banner -->
